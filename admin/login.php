            ...
            <div class="col-md-6 brand-section">
                <div class="d-flex flex-column h-100">
                    ...
                    <div class="mb-auto text-center text-md-start">
                        ...
                        <p style="margin-top: 20px; position: relative;">Admin Dashboard Portal</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                    ...
                    <div class="card-body login-card">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="text-center">
                                <p class="mb-2">Belum punya akun admin?</p>
                                <a href="register.php" class="text-decoration-none">
                                    <i class="bi bi-person-plus me-1"></i>Register Admin
                                </a>
                            </div>
                        </form>
                    </div>
