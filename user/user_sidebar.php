...
?>
<div id="sidebar" class="text-white position-fixed h-100" style="width: 250px; top: 0; left: 0; z-index: 1030; background: linear-gradient(180deg,rgb(60, 140, 231) 0%,rgb(43, 53, 192) 100%);">
    <div class="p-3">
        ...
        <div class="d-flex align-items-center mb-4" style="margin-left:15px; margin-top: 10px;">
            ...
            <h4 class="text-white mb-0" style="font-family: 'Poppins', sans-serif; font-weight: bold; margin-left: -5px; font-size: 18px;">Futsal User</h4>
        </div>
        ...
        <ul class="nav flex-column" style="margin-bottom: 50px;">
            <li class="nav-item mb-2">
                <a href="lihat_lapangan.php" class="nav-link text-white <?php echo ($current_page == 'lihat_lapangan.php') ? 'active' : ''; ?>">
                    <i class="bi bi-building me-2"></i> Lihat Lapangan
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="history.php" class="nav-link text-white <?php echo ($current_page == 'history.php') ? 'active' : ''; ?>">
                    <i class="bi bi-plus-circle me-2"></i> History Booking
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="booking.php" class="nav-link text-white <?php echo ($current_page == 'booking.php') ? 'active' : ''; ?>">
                    <i class="bi bi-check-circle me-2"></i> Booking Lapangan
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="profile.php" class="nav-link text-white <?php echo ($current_page == 'profile.php') ? 'active' : ''; ?>">
                    <i class="bi bi-list-check me-2"></i> Profile
                </a>
            </li>
        </ul>
